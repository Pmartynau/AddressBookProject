...
//CHANGE DEFAULT ADDRESS CANCEL BUTTON
export const CANCEL_DEFAULT_ADDRESS = 'CANCEL_DEFAULT_ADDRESS';
export const ACCEPT_DEFAULT_ADDRESS = 'ACCEPT_DEFAULT_ADDRESS';

//EDIT DEFAULT ADDRESS CONFIRMATION MODAL
export const EDIT_CONFIRM_DEFAULT_ADDRESS = 'EDIT_CONFIRM_DEFAULT_ADDRESS';
export const EDIT_CANCEL_DEFAULT_ADDRESS = 'EDIT_CANCEL_DEFAULT_ADDRESS';
/**
...
// NEWNEW EDIT CONFIRMATION DEFAULT ADDRESS MODAL
export const editConfirmDefaultAddress = () => ({
  type: EDIT_CONFIRM_DEFAULT_ADDRESS
});
export const editCancelDefaultAddress = () => ({
  type: EDIT_CANCEL_DEFAULT_ADDRESS
});

/**
 *  NEW This action will be called if we cancel edit change default address CANCEL_DEFAULT ADDRESS
 */
export const cancelChangeDefaultAddress = () => ({
  type: CANCEL_DEFAULT_ADDRESS
});

export const acceptChangeDefaultAddress = payload => ({
  type: ACCEPT_DEFAULT_ADDRESS,
  payload
});
